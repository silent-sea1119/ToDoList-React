...
var MyButtonController = React.createClass({
    ...
    render: function () {
        return React.createElement(MyButton, { Onlick: this.createNewItem });
    }
});

ReactDOM.render(React.createElement(MyButtonController, null), document.getElementById('container'));
